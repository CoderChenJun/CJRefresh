...
#define kMinBottomPadding   5
#define kMaxBottomPadding   10

#define kMinTopRadius       12
#define kMaxTopRadius       15
#define kMinBottomRadius    3
#define kMaxBottomRadius    15

#define kMinArrowSize       2// 箭头粗细Min
#define kMaxArrowSize       3// 箭头粗细Max
#define kMinArrowRadius     5// 箭头半径大小Min
#define kMaxArrowRadius     7// 箭头半径大小Max

@interface CJRefreshControl ()
...
@implementation CJRefreshControl
...
- (instancetype)initInScrollView:(UIScrollView *)scrollView activityIndicatorView:(UIView *)activity
{
    ...
    if (self) {
        ...
        _shapeLayer.strokeColor   = [_tintColor colorWithAlphaComponent:0.5].CGColor;
        ...
        _arrowLayer.strokeColor = [_arrowColor colorWithAlphaComponent:0.5].CGColor;
